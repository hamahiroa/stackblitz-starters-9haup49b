export default function IntroSlide() {
  return (
    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-900 to-black p-12">
      <div className="max-w-5xl w-full">
        ...
        <div className="bg-gray-950 rounded-lg p-8 border border-gray-800 shadow-2xl font-mono text-sm">
          <div className="text-cyan-400 mb-6 text-2xl"># はじめに：前提のロード</div>
          ...
          <div className="space-y-6 text-gray-300">
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="pl-4 border-l-2 border-cyan-600">
                CS（コンピュータサイエンス）と物理学のTreeは、
                <br />
                実は驚くほど<span className="text-pink-400 font-bold">似ている</span>
              </div>
            </div>

            <div className="animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
              <div className="text-red-400 mb-2">## ⚠️ 免責事項</div>
              <div className="pl-4 border-l-2 border-red-600">
                ...
                エンジニア視点でハックする、
                <br />
                <span className="text-purple-400">SF的エンタメ・ドキュメント</span>である。
              </div>
            </div>
          </div>

          <div className="mt-8 text-gray-500 animate-blink">
